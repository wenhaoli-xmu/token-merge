...
def prune(hidden_states, logits, sampling, merge_method):
    ...
    if merge_method == 'add':
        ...
        assert batch_size == 1, f"only support 1 batch size currently."
        ...
        hidden_states[:, :-1, :][mask_expand] = merged.ravel()
